...
Function: draw seoulmap with dataset(NAME,VALUE) NAME should be the name of area of seoul

Parameter: dataset, value  

Return: m(visualized map)

Conditions: 
    - dataset should be the name of area in seoul
    - value should be same size with dataset and numerical value
"""
